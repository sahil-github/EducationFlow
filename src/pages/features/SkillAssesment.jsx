...
function SkillAssesment() {
    ...
    return (
        ...
        <div className="flex justify-center items-start gap-6 w-full min-h-screen px-4 sm:px-6 py-6 sm:py-6">
            <button
                type="button"
            ...
            <div className="w-full max-w-xl flex flex-col gap-6">
                ...
                {/* Navigation Buttons */}
                <div className="w-full flex items-center justify-end gap-2 mt-2 p-1">
                    <Button
                        variant='primary'
